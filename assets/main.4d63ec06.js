var B=Object.defineProperty,L=Object.defineProperties;var G=Object.getOwnPropertyDescriptors;var k=Object.getOwnPropertySymbols;var z=Object.prototype.hasOwnProperty,U=Object.prototype.propertyIsEnumerable;var P=(e,t,a)=>t in e?B(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a,m=(e,t)=>{for(var a in t||(t={}))z.call(t,a)&&P(e,a,t[a]);if(k)for(var a of k(t))U.call(t,a)&&P(e,a,t[a]);return e},b=(e,t)=>L(e,G(t));import{p as V,e as M,t as g,n as q,s as h,d as A,a as S,b as f,W as $,c as H,f as W,l,g as X,h as d,i as K}from"./vendor.621e38c1.js";const Q=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}};Q();String.prototype.compress=function(e){e=e===!0;var t,a={},s=this,n,i,o="",x=[],u="",T=256;for(t=0;t<256;t+=1)a[String.fromCharCode(t)]=t;for(t=0;t<s.length;t+=1)n=s.charAt(t),i=o+n,a.hasOwnProperty(i)?o=i:(x.push(a[o]),u+=String.fromCharCode(a[o]),a[i]=T++,o=String(n));return o!==""&&(x.push(a[o]),u+=String.fromCharCode(a[o])),e?x:u};String.prototype.decompress=function(){var e,t=[],a=[],s=this,n,i,o,x="",u=256;for(e=0;e<256;e+=1)a[e]=String.fromCharCode(e);if(s&&typeof s=="string"){for(e=0;e<s.length;e+=1)t.push(s[e].charCodeAt(0));s=t,t=null}for(n=String.fromCharCode(s[0]),i=n,e=1;e<s.length;e+=1){if(o=s[e],a[o])x=a[o];else if(o===u)x=n+n.charAt(0);else return null;i+=x,a[u++]=n+x.charAt(0),n=x}return i};const Y=()=>["createObject","currentItem","deleteItem","deleteObject","executeNode","findObject","get","getCollection","getContents","getCurrentItem","getItem","getText","hasSomething","loadAll","loadFromJson","loadFromJsonArray","moveFirst","moveLast","moveNext","movePrev","msgBox","msgBoxWithSound","pickFile","save","setText","sleep","startBrowse","startCamera","startGps","startGpsV1","startGpsV2"];let y;const J=["body","expression","declarations","init","callee","object","argument","arguments","right"],Z=()=>y=Y(),ee=new DOMParser;function te(e,t){try{if(!t)return e;ee.parseFromString(`<root>${e}</root>`,"text/xml").querySelectorAll("action > script").forEach(s=>e=e.replace(s.textContent,`
...
`).join("~~"))})}catch{}const s=V(a,{ecmaVersion:2022}),n=(o,x,u=!1)=>{var D,N,F,w;((D=o.type)==null?void 0:D.includes("Function"))&&x.push(o),J.forEach(r=>{!o[r]||n(o[r],x,u)}),x=x.filter(r=>r!==o),o instanceof Array&&o.forEach(r=>{n(r,x,u)});const T=((N=o.callee)==null?void 0:N.name)||((w=(F=o.callee)==null?void 0:F.property)==null?void 0:w.name);if(!(!T||!y.includes(T)))if(u){if(x.length===0)return;const{name:r}=x[0].id;y.includes(r)||y.push(r)}else{const r=m({},o);o.type="AwaitExpression",o.argument=r,x.forEach(j=>j.async=!0)}};let i;do i=y.length,s.body.forEach(o=>n(o,[],!0));while(i!==y.length);return s.body.forEach(o=>n(o,[])),M.generate(s)}catch{return""}}var ae=Object.defineProperty,oe=Object.getOwnPropertyDescriptor,p=(e,t,a,s)=>{for(var n=s>1?void 0:s?oe(t,a):t,i=e.length-1,o;i>=0;i--)(o=e[i])&&(n=(s?o(t,a,n):o(n))||n);return s&&n&&ae(t,a,n),n};let c=class extends h{constructor(){super();this.xmlString="",this.cssString="",this.jsString="",this.urlParam="",this.settings={resolutionWidth:-1,resolutionHeight:-1,webLayout:"",scaleFontsize:"false",fontFactor:5},this.isSettingsOpened=!1,this.initEditorValues()}createRenderRoot(){return this}initEditorValues(){try{const{hash:e}=window.location,[t,a,s,n,i,o,x,u]=e.split(e.includes("%7C")?"%7C":"|");if(t&&(this.xmlString=A(t).decompress()),a&&(this.cssString=A(a).decompress()),s&&(this.jsString=A(s).decompress()),n)try{this.settings.resolutionWidth=Number(n)}catch{}i&&(this.settings.resolutionHeight=Number(i)),o&&(this.settings.webLayout=A(o.decompress())),x&&(this.settings.scaleFontsize=x),u&&(this.settings.fontFactor=Number(u))}catch{}}reloadPreview(){var a;this.updateUrl(!0);const e=document.querySelector("xone-preview");e&&((a=e.parentElement)==null||a.removeChild(e));const t=document.getElementById("editor-panel");t.innerHTML=`<xone-preview url="https://mrscolo.github.io/xone-framework/" urlParam=${this.urlParam}></xone-preview>`}updated(e){!e.has("xmlString")&&!e.has("cssString")&&!e.has("jsString")||!this.xmlString&&!this.cssString&&!this.jsString||(this.updateUrl(!1),this.updateTimeout&&clearTimeout(this.updateTimeout),this.updateTimeout=setTimeout(()=>this.reloadPreview(),document.querySelector("xone-preview")?2500:0))}updateUrl(e){const{resolutionWidth:t,resolutionHeight:a,webLayout:s,scaleFontsize:n,fontFactor:i}=this.settings,o=ne(this.jsString,e),x=te(this.xmlString,e);let u=`${S(x.compress())}|${S(this.cssString.compress())}|${S(o.compress())}`;u+=`|${t.toString()}|${a.toString()}|${S(s.toString().compress())}`,u+=`|${n}|${i}`,e?this.urlParam=u:window.location.hash=u}render(){return f`
		...
		`}};p([g()],c.prototype,"xmlString",2);p([g()],c.prototype,"cssString",2);p([g()],c.prototype,"jsString",2);p([g()],c.prototype,"urlParam",2);p([g()],c.prototype,"settings",2);p([g()],c.prototype,"isSettingsOpened",2);c=p([q("xone-app")],c);var se=`<?xml version="1.0" encoding="utf-8" ?>
...
<xs:any namespace='##local'
  ...
  <xs:element name="xml">
	...
	<action name="runscript">
...
</\${1:methodName}>`}]}}});const ue=(e,t)=>X.create(e,m({value:"",language:t},ie()));function le(e){let t=e.match(/<\/*(?=\S*)([a-zA-Z-]+)/g);if(!t)return;let a=[];for(let s=t.length-1;s>=0;s--)if(t[s].indexOf("</")===0)a.push(t[s].substring("</".length));else{let n=e.lastIndexOf(t[s]),i=t[s].substring("<".length);if(e.indexOf("/>",n)===-1){if(!a.length||a[a.length-1]!==i)return e=e.substring(n),{tagName:i,isAttributeSearch:e.indexOf("<")>e.indexOf(">")};a.splice(a.length-1,1)}e=e.substring(0,n)}}var re=Object.defineProperty,me=Object.getOwnPropertyDescriptor,v=(e,t,a,s)=>{for(var n=s>1?void 0:s?me(t,a):t,i=e.length-1,o;i>=0;i--)(o=e[i])&&(n=(s?o(t,a,n):o(n))||n);return s&&n&&re(t,a,n),n};let _=class extends h{constructor(){super();this.type="",this.editor=null}createRenderRoot(){return this}render(){return f`
			<div class="editor-container">
				<div class="code-editor"></div>
			</div>
		`}firstUpdated(){this.createEditor()}async createEditor(){this.editor&&(this.editor.dispose(),await new Promise(e=>setTimeout(()=>e(!0),100))),this.editor=ue(this.editorElement,this.type),this.editor.setValue(this.editorValue),this.editor.onDidChangeModelContent(()=>this.onUpdate(this.editor.getValue()))}};v([d({type:String})],_.prototype,"type",2);v([d({type:String})],_.prototype,"editorValue",2);v([d({type:Function})],_.prototype,"onUpdate",2);v([K(".code-editor")],_.prototype,"editorElement",2);_=v([q("code-editor")],_);var ce=Object.defineProperty,de=Object.getOwnPropertyDescriptor,E=(e,t,a,s)=>{for(var n=s>1?void 0:s?de(t,a):t,i=e.length-1,o;i>=0;i--)(o=e[i])&&(n=(s?o(t,a,n):o(n))||n);return s&&n&&ce(t,a,n),n};let C=class extends h{constructor(){super(...arguments);this.url="http://localhost:8080/"}createRenderRoot(){return this}render(){return f`<iframe src="${this.url}#/preview?v=${this.urlParam}"></iframe>`}};E([d({type:String})],C.prototype,"url",2);E([d({type:String})],C.prototype,"urlParam",2);C=E([q("xone-preview")],C);var pe=Object.defineProperty,be=Object.getOwnPropertyDescriptor,I=(e,t,a,s)=>{for(var n=s>1?void 0:s?be(t,a):t,i=e.length-1,o;i>=0;i--)(o=e[i])&&(n=(s?o(t,a,n):o(n))||n);return s&&n&&pe(t,a,n),n};let O=class extends h{createRenderRoot(){return this}render(){var e;return f` <div class="settings">
		...
		</div>`}updateSettings(e,t){switch(t){case"resolutionWidth":return this.onUpdate(b(m({},this.settings),{resolutionWidth:Number(e.value)}));case"resolutionHeight":return this.onUpdate(b(m({},this.settings),{resolutionHeight:Number(e.value)}));case"fontFactor":return this.onUpdate(b(m({},this.settings),{fontFactor:Number(e.value)}));case"webLayout":return this.onUpdate(b(m({},this.settings),{webLayout:e.value}));case"scaleFontsize":return this.onUpdate(b(m({},this.settings),{scaleFontsize:e.value}))}}reloadEditors(){document.querySelectorAll("code-editor").forEach(e=>e.createEditor())}};I([d({type:Object})],O.prototype,"settings",2);I([d({type:Function})],O.prototype,"onUpdate",2);O=I([q("xone-settings")],O);
