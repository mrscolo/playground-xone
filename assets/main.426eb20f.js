var F=Object.defineProperty,R=Object.defineProperties;var z=Object.getOwnPropertyDescriptors;var P=Object.getOwnPropertySymbols;var E=Object.prototype.hasOwnProperty,N=Object.prototype.propertyIsEnumerable;var T=(t,e,s)=>e in t?F(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s,u=(t,e)=>{for(var s in e||(e={}))E.call(e,s)&&T(t,s,e[s]);if(P)for(var s of P(e))N.call(e,s)&&T(t,s,e[s]);return t},h=(t,e)=>R(t,z(e));import{t as g,n as S,s as y,d as $,e as w,p as v,W as j,a as L,b as W,l as a,c as U,f as d,i as A}from"./vendor.ad1ab897.js";const H=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function s(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerpolicy&&(r.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?r.credentials="include":i.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(i){if(i.ep)return;i.ep=!0;const r=s(i);fetch(i.href,r)}};H();String.prototype.compress=function(t){t=t===!0;var e,s={},o=this,i,r,n="",l=[],p="",_=256;for(e=0;e<256;e+=1)s[String.fromCharCode(e)]=e;for(e=0;e<o.length;e+=1)i=o.charAt(e),r=n+i,s.hasOwnProperty(r)?n=r:(l.push(s[n]),p+=String.fromCharCode(s[n]),s[r]=_++,n=String(i));return n!==""&&(l.push(s[n]),p+=String.fromCharCode(s[n])),t?l:p};String.prototype.decompress=function(){var t,e=[],s=[],o=this,i,r,n,l="",p=256;for(t=0;t<256;t+=1)s[t]=String.fromCharCode(t);if(o&&typeof o=="string"){for(t=0;t<o.length;t+=1)e.push(o[t].charCodeAt(0));o=e,e=null}for(i=String.fromCharCode(o[0]),r=i,t=1;t<o.length;t+=1){if(n=o[t],s[n])l=s[n];else if(n===p)l=i+i.charAt(0);else return null;r+=l,s[p++]=i+l.charAt(0),i=l}return r};var D=Object.defineProperty,V=Object.getOwnPropertyDescriptor,m=(t,e,s,o)=>{for(var i=o>1?void 0:o?V(e,s):e,r=t.length-1,n;r>=0;r--)(n=t[r])&&(i=(o?n(e,s,i):n(i))||i);return o&&i&&D(e,s,i),i};let c=class extends y{constructor(){super();this.xmlString="",this.cssString="",this.jsString="",this.urlParam="",this.settings={resolutionWidth:-1,resolutionHeight:-1,webLayout:"",scaleFontsize:"false",fontFactor:5},this.isSettingsOpened=!1,this.initEditorValues()}createRenderRoot(){return this}initEditorValues(){try{const{hash:t}=window.location,[e,s,o,i,r,n,l,p]=t.split(t.includes("%7C")?"%7C":"|");if(e&&(this.xmlString=$(e).decompress()),s&&(this.cssString=$(s).decompress()),o&&(this.jsString=$(o).decompress()),i)try{this.settings.resolutionWidth=Number(i)}catch{}r&&(this.settings.resolutionHeight=Number(r)),n&&(this.settings.webLayout=$(n.decompress())),l&&(this.settings.scaleFontsize=l),p&&(this.settings.fontFactor=Number(p))}catch{}}reloadPreview(){var s;const t=document.querySelector("xone-preview");t&&((s=t.parentElement)==null||s.removeChild(t));const e=document.getElementById("editor-panel");e.innerHTML=`<xone-preview url="https://mrscolo.github.io/xone-framework/" urlParam=${this.urlParam}></xone-preview>`}updated(t){!t.has("xmlString")&&!t.has("cssString")&&!t.has("jsString")||!this.xmlString&&!this.cssString&&!this.jsString||(this.updateUrl(),this.updateTimeout&&clearTimeout(this.updateTimeout),this.updateTimeout=setTimeout(()=>this.reloadPreview(),document.querySelector("xone-preview")?1e3:0))}updateUrl(){const{resolutionWidth:t,resolutionHeight:e,webLayout:s,scaleFontsize:o,fontFactor:i}=this.settings;this.urlParam=`${w(this.xmlString.compress())}|${w(this.cssString.compress())}|${w(this.jsString.compress())}`,this.urlParam+=`|${t.toString()}|${e.toString()}|${w(s.toString().compress())}`,this.urlParam+=`|${o}|${i}`,window.location.hash=this.urlParam}render(){return v`
			<div class="main-layout">
				<!-- XOne image -->
				<div id="lucas" style="position:absolute;z-index:1;bottom:25px;left:100px;opacity:.2;">
	...
	<action name="runscript">
...
</\${1:methodName}>`}]})});const M=(t,e)=>U.create(t,u({value:"",language:e},K()));var X=Object.defineProperty,q=Object.getOwnPropertyDescriptor,b=(t,e,s,o)=>{for(var i=o>1?void 0:o?q(e,s):e,r=t.length-1,n;r>=0;r--)(n=t[r])&&(i=(o?n(e,s,i):n(i))||i);return o&&i&&X(e,s,i),i};let f=class extends y{constructor(){super();this.type="",this.editor=null}createRenderRoot(){return this}render(){return v`
			<div class="editor-container">
				<div class="code-editor"></div>
			</div>
		`}firstUpdated(){this.createEditor()}async createEditor(){this.editor&&(this.editor.dispose(),await new Promise(t=>setTimeout(()=>t(!0),100))),this.editor=M(this.editorElement,this.type),this.editor.setValue(this.editorValue),this.editor.onDidChangeModelContent(()=>this.onUpdate(this.editor.getValue()))}};b([d({type:String})],f.prototype,"type",2);b([d({type:String})],f.prototype,"editorValue",2);b([d({type:Function})],f.prototype,"onUpdate",2);b([A(".code-editor")],f.prototype,"editorElement",2);f=b([S("code-editor")],f);var B=Object.defineProperty,J=Object.getOwnPropertyDescriptor,C=(t,e,s,o)=>{for(var i=o>1?void 0:o?J(e,s):e,r=t.length-1,n;r>=0;r--)(n=t[r])&&(i=(o?n(e,s,i):n(i))||i);return o&&i&&B(e,s,i),i};let x=class extends y{constructor(){super(...arguments);this.url="http://localhost:8080/"}createRenderRoot(){return this}render(){return v`<iframe src="${this.url}#/preview?v=${this.urlParam}"></iframe>`}};C([d({type:String})],x.prototype,"url",2);C([d({type:String})],x.prototype,"urlParam",2);x=C([S("xone-preview")],x);var k=Object.defineProperty,G=Object.getOwnPropertyDescriptor,O=(t,e,s,o)=>{for(var i=o>1?void 0:o?G(e,s):e,r=t.length-1,n;r>=0;r--)(n=t[r])&&(i=(o?n(e,s,i):n(i))||i);return o&&i&&k(e,s,i),i};let I=class extends y{createRenderRoot(){return this}render(){var t;return v` <div class="settings">
		...
		</div>`}updateSettings(t,e){switch(e){case"resolutionWidth":return this.onUpdate(h(u({},this.settings),{resolutionWidth:Number(t.value)}));case"resolutionHeight":return this.onUpdate(h(u({},this.settings),{resolutionHeight:Number(t.value)}));case"fontFactor":return this.onUpdate(h(u({},this.settings),{fontFactor:Number(t.value)}));case"webLayout":return this.onUpdate(h(u({},this.settings),{webLayout:t.value}));case"scaleFontsize":return this.onUpdate(h(u({},this.settings),{scaleFontsize:t.value}))}}reloadEditors(){document.querySelectorAll("code-editor").forEach(t=>t.createEditor())}};O([d({type:Object})],I.prototype,"settings",2);O([d({type:Function})],I.prototype,"onUpdate",2);I=O([S("xone-settings")],I);
