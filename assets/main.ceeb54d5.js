var k=Object.defineProperty,M=Object.defineProperties;var U=Object.getOwnPropertyDescriptors;var P=Object.getOwnPropertySymbols;var G=Object.prototype.hasOwnProperty,X=Object.prototype.propertyIsEnumerable;var L=(e,t,a)=>t in e?k(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a,m=(e,t)=>{for(var a in t||(t={}))G.call(t,a)&&L(e,a,t[a]);if(P)for(var a of P(t))X.call(t,a)&&L(e,a,t[a]);return e},g=(e,t)=>M(e,U(t));import{p as B,e as z,t as y,n as A,s as h,d as N,a as T,b as f,W as w,c as $,l as x,f as H,g as d,i as W}from"./vendor.c12cbb47.js";const K=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}};K();String.prototype.compress=function(e){e=e===!0;var t,a={},s=this,n,i,o="",r=[],l="",b=256;for(t=0;t<256;t+=1)a[String.fromCharCode(t)]=t;for(t=0;t<s.length;t+=1)n=s.charAt(t),i=o+n,a.hasOwnProperty(i)?o=i:(r.push(a[o]),l+=String.fromCharCode(a[o]),a[i]=b++,o=String(n));return o!==""&&(r.push(a[o]),l+=String.fromCharCode(a[o])),e?r:l};String.prototype.decompress=function(){var e,t=[],a=[],s=this,n,i,o,r="",l=256;for(e=0;e<256;e+=1)a[e]=String.fromCharCode(e);if(s&&typeof s=="string"){for(e=0;e<s.length;e+=1)t.push(s[e].charCodeAt(0));s=t,t=null}for(n=String.fromCharCode(s[0]),i=n,e=1;e<s.length;e+=1){if(o=s[e],a[o])r=a[o];else if(o===l)r=n+n.charAt(0);else return null;i+=r,a[l++]=n+r.charAt(0),n=r}return i};const J=()=>["createObject","currentItem","deleteItem","deleteObject","executeNode","findObject","get","getCollection","getContents","getCurrentItem","getItem","getText","hasSomething","loadAll","loadFromJson","loadFromJsonArray","moveFirst","moveLast","moveNext","movePrev","msgBox","msgBoxWithSound","pickFile","save","setText","sleep","startBrowse","startCamera","startGps","startGpsV1","startGpsV2"];let v;const Y=["body","expression","declarations","init","callee","object","argument","arguments","right"],Q=()=>v=J(),Z=new DOMParser;function ee(e,t){try{if(!t)return e;Z.parseFromString(`<root>${e}</root>`,"text/xml").querySelectorAll("action > script").forEach(s=>e=e.replace(s.textContent,`
`+R(s.textContent)))}catch{}finally{return e}}function te(e,t){try{return t?(Q(),R(e)):e}catch{return e}}function R(e){try{const t=e;let a=t;try{t.match(/'([^']+)'/).forEach(o=>{a=a.replace(o,o.split(`
`).join("~~"))})}catch{}const s=B(a,{ecmaVersion:2022}),n=(o,r,l=!1)=>{var F,D,I,j;((F=o.type)==null?void 0:F.includes("Function"))&&r.push(o),Y.forEach(u=>{!o[u]||n(o[u],r,l)}),r=r.filter(u=>u!==o),o instanceof Array&&o.forEach(u=>{n(u,r,l)});const b=((D=o.callee)==null?void 0:D.name)||((j=(I=o.callee)==null?void 0:I.property)==null?void 0:j.name);if(!(!b||!v.includes(b)))if(l){if(r.length===0)return;const{name:u}=r[0].id;v.includes(u)||v.push(u)}else{const u=m({},o);o.type="AwaitExpression",o.argument=u,r.forEach(V=>V.async=!0)}};let i;do i=v.length,s.body.forEach(o=>n(o,[],!0));while(i!==v.length);return s.body.forEach(o=>n(o,[])),z.generate(s)}catch{return""}}var ne=Object.defineProperty,ae=Object.getOwnPropertyDescriptor,p=(e,t,a,s)=>{for(var n=s>1?void 0:s?ae(t,a):t,i=e.length-1,o;i>=0;i--)(o=e[i])&&(n=(s?o(t,a,n):o(n))||n);return s&&n&&ne(t,a,n),n};let c=class extends h{constructor(){super();this.xmlString="",this.cssString="",this.jsString="",this.urlParam="",this.settings={resolutionWidth:-1,resolutionHeight:-1,webLayout:"",scaleFontsize:"false",fontFactor:5},this.isSettingsOpened=!1,this.initEditorValues()}createRenderRoot(){return this}initEditorValues(){try{const{hash:e}=window.location,[t,a,s,n,i,o,r,l]=e.split(e.includes("%7C")?"%7C":"|");if(t&&(this.xmlString=N(t).decompress()),a&&(this.cssString=N(a).decompress()),s&&(this.jsString=N(s).decompress()),n)try{this.settings.resolutionWidth=Number(n)}catch{}i&&(this.settings.resolutionHeight=Number(i)),o&&(this.settings.webLayout=N(o.decompress())),r&&(this.settings.scaleFontsize=r),l&&(this.settings.fontFactor=Number(l))}catch{}}reloadPreview(){var a;this.updateUrl(!0);const e=document.querySelector("xone-preview");e&&((a=e.parentElement)==null||a.removeChild(e));const t=document.getElementById("editor-panel");t.innerHTML=`<xone-preview url="https://mrscolo.github.io/xone-framework/" urlParam=${this.urlParam}></xone-preview>`}updated(e){!e.has("xmlString")&&!e.has("cssString")&&!e.has("jsString")||!this.xmlString&&!this.cssString&&!this.jsString||(this.updateUrl(!1),this.updateTimeout&&clearTimeout(this.updateTimeout),this.updateTimeout=setTimeout(()=>this.reloadPreview(),document.querySelector("xone-preview")?2500:0))}updateUrl(e){const{resolutionWidth:t,resolutionHeight:a,webLayout:s,scaleFontsize:n,fontFactor:i}=this.settings,o=te(this.jsString,e),r=ee(this.xmlString,e);let l=`${T(r.compress())}|${T(this.cssString.compress())}|${T(o.compress())}`;l+=`|${t.toString()}|${a.toString()}|${T(s.toString().compress())}`,l+=`|${n}|${i}`,e?this.urlParam=l:window.location.hash=l}render(){return f`
		...
		`}};p([y()],c.prototype,"xmlString",2);p([y()],c.prototype,"cssString",2);p([y()],c.prototype,"jsString",2);p([y()],c.prototype,"urlParam",2);p([y()],c.prototype,"settings",2);p([y()],c.prototype,"isSettingsOpened",2);c=p([A("xone-app")],c);var oe=`<?xml version="1.0" encoding="utf-8" ?>
...
`;window.MonacoEnvironment={getWorker:function(e,t){switch(t){case"css":return new w;case"javascript":return new $;default:return new w}}};const ue=()=>{var t;return{automaticLayout:!0,fontSize:Number((t=localStorage.getItem("fontSize"))!=null?t:"14"),scrollBeyondLastLine:!0,padding:{top:16},minimap:{enabled:localStorage.getItem("minimap")!=="off"},theme:localStorage.getItem("theme")||"vs-dark"}},me=new DOMParser().parseFromString(oe,"text/xml");x.typescript.javascriptDefaults.addExtraLib(`
	${se}
	${re}
	${ie}
	${le}
